    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (response.token) {
                ...
                window.location.href = '/'; // Use window.location to force full page reload
            } else {
                // Token wasn't returned - something's wrong
                    ...
                    <div className="rounded-md shadow-sm -space-y-px">
                        <div>
                            ...
                            <input
                                ...
                                autoComplete="email"
                                required
                                className="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-700 placeholder-gray-500 text-white bg-dark rounded-t-md focus:outline-none focus:ring-primary focus:border-primary focus:z-10 sm:text-sm"
